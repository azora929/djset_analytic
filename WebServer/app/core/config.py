...
7) В конце сводки обязательно добавь 2 строки с процентами:
   "Современные треки (2021+) - XX.X%"
   "Устаревшие треки (до 2021) - YY.Y%"
8) Отдельно посчитай процент окон без найденных треков и выведи:
   "Не найденные треки (по окнам) - ZZ.Z%"
